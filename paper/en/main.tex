...
\author{%
  Xinhao Zheng\thanks{Correspondence: \texttt{xinhaozheng.vx@outlook.com}.
    Code: \url{https://github.com/xinhao-zheng/constraint-layer}. The
    figures are schematic; no empirical series is plotted.}\\[2pt]
...
dataset. All claims rest on the cited literature.
