...
\author{%
  Xinhao Zheng\thanks{通讯邮箱：\texttt{xinhaozheng.vx@outlook.com}。代码：
    \url{https://github.com/xinhao-zheng/constraint-layer}。两幅插图均为示意
    图，未绘制任何经验序列。本稿为中文对照版本；arXiv 正式投稿以英文版为准。}\\[2pt]
  \small 独立研究者}
...
\paragraph*{数据可得性}
本文为理论贡献；不报告任何实验、任何数据集。所有主张均依托于所引文献。
